%% sjFuzzy spiking neural network, Liver %%
% M = 8; Q = 11; K = 5; L = 12; tau = 7; beta = 0.5; eta = 0.009;

%save('sjFSNN_Liver_jd.mat')
clear
close all
clc
P = 1;
...
for i = 1:10 %循环10次，分别取出第i部分作为测试样本，其余部分作为训练样本
    ...
    Q = 12; % the number of hidden layer
    K = 5; %the number of sysnaptsis
    L = 12; % the interval
    tau = 7;
    beta = 0.5;                % the parameter or the Gaussian code
    eta = 0.009;
    % eta1 = eta/P;
    % eta2= eta1/Q;
    % eta1 = eta;
